...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final ArrayList<Item> listItem = new ArrayList<>(Arrays.asList(
                new Item(R.drawable.ic_account_circle_black_24dp, getString(R.string.account),
                        getString(R.string.account_content), "", ""),
                new Item(R.drawable.ic_favorite_black_24dp, getString(R.string.saved),
                        getString(R.string.saved_content), "", "")
        ));
        ItemAdapter itemAdapter = new ItemAdapter(this, listItem, R.color.colorAccomodation, true);
        ListView listView = findViewById(R.id.list_item_setting_account);
