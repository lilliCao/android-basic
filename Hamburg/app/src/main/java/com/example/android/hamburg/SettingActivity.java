...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final ArrayList<Item> listItem = new ArrayList<>(Arrays.asList(
                new Item(R.drawable.ic_settings_black_24dp, getString(R.string.setting), getString(R.string.setting_t), "", "")
        ));
        ItemAdapter itemAdapter = new ItemAdapter(this, listItem, R.color.colorAccomodation, true);
        ListView listView = findViewById(R.id.list_item_setting_setting);
